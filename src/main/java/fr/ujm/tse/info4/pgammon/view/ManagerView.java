...
private JList<String> questionList;
 ...
 private void initializeComponents() {
     ...
     // Card Panel for View/Edit modes
 ...
 public void displayQuestion(Question question) {
     ...
     for (int i = 0; i < 4; i++) {
         viewAnswerFields[i].setText(answers.get(i));
     }

     viewCorrectAnswer.setText(question.getAnswers().get(question.getCorrectAns()));
     
     if(question.getDifficulty()==1) {
         viewDifficulty.setText("Easy");
     }else if(question.getDifficulty()==2) {
    	 viewDifficulty.setText("Medium");
     }else if(question.getDifficulty()==3) {
    	 viewDifficulty.setText("Hard");
     }
